---
title: "Tutorial para usar y crear paletas y personalizar temas de gráficos en ggplot"
...
El primer paso es cargar las siguientes librerías que nos permitirán dar formato a los gráficos:
...
## ¿Cómo crear nuestra propia paleta? {data-background=awtools.png data-background-size="50% 100%" background-position=bottom}
...
```{r}
col_d_1 <- c("#3D98D3FF", "#EC0B88FF", "#5E35B1FF", 
             "#F9791EFF","#3DD378FF", "#444444FF")
```

## ¿Cómo utilizamos nuestra paleta?

Ahora que hemos creado el vector <span class="red3">**col_d_1** </span> podemos utilizar sus colores para rellenar los gráficos <span class="red3" >**barras1 puntos1** </span> que creamos anteriormente. Para esto debemos utilizar la función <span class="red3" > **scale_fill_manual** </span> para el gráfico de barras y <span class="red3" >**scale_color_manual** </span> para los gráficos de puntos.
...
## ¿Cómo utilizamos nuestra paleta? {.smaller}
