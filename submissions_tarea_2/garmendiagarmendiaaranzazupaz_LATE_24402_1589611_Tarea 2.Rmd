...
En esta tarea vamos a usar `kable` solamente como una función que transforma un tibble o data frame y lo convierte en tabla. Y aunque `kable` incluye varias opciones para modificar la tabla (ver por ejemplo [aquí](https://bookdown.org/yihui/rmarkdown-cookbook/kable.html){style="blue"}), no profundizaremos en las opciones de esta función. En cambio invertiremos tiempo en usar el paquete `kableExtra`
